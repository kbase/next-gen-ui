...
/>`}
      ...
      <p className={s.note}>
        ...
        proportions would be most of the space. Every part is drawn, each a step smaller, and the
        description is measured by the column rather than by the 280 pixels a page allows it. The
        icon is sized by the variant, so the same call site serves both.
      </p>
